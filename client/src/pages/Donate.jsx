        ...
        <main className="w-full bg-white rounded-2xl my-12 px-8 py-4 ">
          <div className="mb-8">
            <div className="flex items-center">
              <img className="w-20" src="./src/images/Avatar2.svg" alt="" />
              <h1 className="text-xl font-bold mx-28">username</h1>
            </div>
            <div className="py-4">
              <p className="text-md opacity-60 text-right">
          ...
          <div className="w-full flex gap-4 mb-8 items-center justify-between">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm opacity-60">
                <span>12</span> تا چایی داری و هرچقدر بخوای میتونی دونیت کنی
              </p>
            </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <h2 className="text-xl">نام شما</h2>
              <input
              ...
              <div className="flex gap-4">
                <div class="relative inline-block w-12 h-6">
                  <input
                    id="switch-component"
                    type="checkbox"
                    class="peer appearance-none w-12 h-6 bg-slate-100 rounded-full checked:bg-primary transition-colors duration-300"
                  />
                  <label
                    for="switch-component"
                    class="absolute bottom-1/2 translate-y-1/2 left-1 right-auto size-4 bg-white rounded-full transition-all duration-300 peer-checked:left-7"
                  ></label>
                </div>
